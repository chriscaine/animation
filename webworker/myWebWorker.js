//var IDBTransaction = IDBTransaction || webkitIDBTransaction || { READ_WRITE: "readwrite" };
/*importScripts("/webworker/ffmpeg-all-codecs.js");
var now = Date.now;
...
*/
importScripts('ffmpeg-all-codecs.js?=1');
